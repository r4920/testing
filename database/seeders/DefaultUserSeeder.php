...
class DefaultUserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $inputUser = [
            ...
            'email' => 'aliza.abernathy@yahoo.com',
            'password' => Hash::make('SF1McyUHsTQUQt0'),
        ...
        $inputAdmin = [
            ...
            'created_at' => $faker->dateTime(),
            'updated_at' => $faker->dateTime(),
            'email' => 'vivien_crooks52@gmail.com',
            'password' => Hash::make('N2_j5aHUJU1eCxc'),
            'email_verified_at' => Carbon::now(),
        ...
        $inputSystemUser = [
            ...
            'created_at' => $faker->dateTime(),
            'updated_at' => $faker->dateTime(),
            'username' => 'trever.reinger',
            'email' => 'zakary.haag@hotmail.com',
            'password' => Hash::make('vhwD/7+IEm'),
            'email_verified_at' => Carbon::now(),
            'user_type' => User::TYPE_ADMIN
        ];
